...
description: Review UI code for Vercel Web Interface Guidelines compliance. Read the target files/components and check them against the rules below. Use for accessibility, focus states, forms, animation, typography, performance, and a11y audits of React/TSX UI.
